...
/// Service logic.
/// </summary>
class AdapterLogic : ICanteenService
{
    /// <summary>
    ...
    private static readonly HttpClient Client = new();
        ...
        {
            Console.WriteLine();
            Console.WriteLine($"{DateTime.Now.ToString("HH:mm:ss")}| Forwarding GetHour() request from simpleRPC client to RabbitMQ server");
            Console.WriteLine();
